...
@Getter
public class ReservationFinishedEvent extends ApplicationEvent {
    private final Reservation reservation;
    private final Mail mail;

    public ReservationFinishedEvent(Reservation reservation, String recipientEmail) {
        super(reservation);
        ...
        Mail mail = Mail.builder()
                ...
                .to(recipientEmail)
                .htmlTemplate(new Mail.HtmlTemplate("ReservationFinishedTemplate", properties))
