...
@Getter
public class ReservationCanceladoEvent extends ApplicationEvent {
    private final Reservation reservation;
    private final Mail mail;

    public ReservationCanceladoEvent(Reservation reservation, String recipientEmail) {
        super(reservation);
        ...
        Mail mail = Mail.builder()
                ...
                .to(recipientEmail)
                .htmlTemplate(new Mail.HtmlTemplate("ReservationCanceladaTemplate", properties))
